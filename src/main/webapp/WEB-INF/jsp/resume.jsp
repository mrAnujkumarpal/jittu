                    ...
                    <div class = "row">
                        <div class="col s12"> 
                            ...
                            <div class="heading">CONTACT INFO :<br>
                                ...
                                <i class="material-icons profile-card-i">location_on</i> E-1, Sector-38, Gurgaon<br>
                            ...
                            <div class="heading">PERSONAL INFO :
                                <br>
                                <span class="collegeName">DOB : </span> 1st May 1992<br>
                                <span class="collegeName">Nationality : </span> Indian<br>
                                <span class="collegeName">Address : </span> Sikenderpur kalan, Khatauli<br>
                                <span class="collegeName">Distt : </span>MuzafferNagar (251201)<br>
                            </div>
                            <br>
                            <div class="heading">PROFESSIONAL LINKS :<br>
                                <i class="fa fa-github profile-card-i" style="font-size:24px"></i><a href="https://github.com/mrAnujkumarpal">https://mrAnujkumarpal</a><br>
                                <i class="fa fa-linkedin profile-card-i" style="font-size:20px"></i> <a href="https://www.linkedin.com/in/anuj-kumar-pal-8095446907/">https://anujkumarpal</a><br>
