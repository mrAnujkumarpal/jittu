...
<html lang="en">
    ...
    <head>
        ...
        <link href="../../assets/css/css/mdb.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <main>
            ...
            <section id="gallery" class="text-center py-5">
                ...
                <div class="container">
                    ...
                    <!-- Section heading -->
                    <h2 class="h1-responsive font-weight-bold mb-5">Our best projects A</h2>
                    <!-- Section description -->
                    <p class="grey-text w-responsive mx-auto mb-5">Duis aute irure dolor in reprehenderit in
                        voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                        cupidatat non proident, sunt in culpa qui officia deserunt mollit est laborum.</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mdb-lightbox">
                                ...
                                <figure class="col-lg-3 col-md-4 col-sm-4">
        ...
        <!-- SCRIPTS -->
        <!-- JQuery -->
        <script src="../../assets/js/js/jquery-3.4.1.min.js" type="text/javascript"></script>
        <!-- Bootstrap tooltips -->
        ...
        <!-- MDB core JavaScript -->
        <script src="../../assets/js/js/mdb.min.js" type="text/javascript"></script>
    </body>
